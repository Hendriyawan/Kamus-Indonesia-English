 ...
 */
public class EngIndFragment extends Fragment implements KamusView, KamusAdapter.OnKamusKlik {
    @BindView(R.id.rv_eng_ind)
        ...
        if (searchManager != null) {
            ...
            searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                ...
                public boolean onQueryTextChange(String query) {
                    presenter.searchWords(query, true);
                    return true;
                }
            });
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_eng_ind, container, false);
        ButterKnife.bind(this, view);

        presenter = new KamusPresenter(getActivity(), this);
        //recycler view kamus english - indonesia
        setupRecyclerView();
        return view;
    }
    ...
    private void setupRecyclerView() {
        ...
        kamusHelper.open();
        adapter.addItem(kamusHelper.getAllData(true));
        kamusHelper.close();
